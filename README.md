...
* [Проект 1. Анализ резюме из HeadHunter](https://github.com/anna-grigoryeva/data_science/blob/main/project_1.ipynb)
* [Проект 2.0 Анализ резюме из HeadHunter через SQL (ссылка на Google Doc)](https://docs.google.com/document/d/1sii9f1eveysYvWB0woemU3m2biyfoGbYyi7HUT3kK5w)
* [Проект 2. Анализ вакансий из HeadHunter через SQL](https://github.com/anna-grigoryeva/data_science/blob/main/project_2.ipynb)
